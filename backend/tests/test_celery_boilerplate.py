...
def test_celery_boilerplate_task_direct(function_mock, celery_session_worker, celery_session_app):
    """
...
@patch('app.tasks.debug.dummy_function')
def test_celery_boilerplate_send_task(function_mock, celery_session_worker, celery_session_app):
    """
